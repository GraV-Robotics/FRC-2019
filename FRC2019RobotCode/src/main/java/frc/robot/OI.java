...
import frc.robot.commands.FillLevelTwoTanks;
import frc.robot.commands.HatchPop;
import frc.robot.commands.HatchPush;
import frc.robot.commands.LevelTwoPistons;
...
public class OI {
  ...
  public JoystickButton fillLevelTwoTanks = new JoystickButton(manipulatorController, 6);
  public JoystickButton hatchPop = new JoystickButton(manipulatorController, 9);
  public JoystickButton levelTwoPistons = new JoystickButton(manipulatorController, 10);
  ...
  public OI() {
    ...
    hatchPush.toggleWhenPressed(new HatchPush());
    // fillLevelTwoTanks.toggleWhenPressed(new FillLevelTwoTanks());
    // levelTwoPistons.toggleWhenPressed(new LevelTwoPistons());
  }
}